...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"> 
    <head> 
        <title>Font to TextStudio</title> 
        ...
        <div id="content" class="background-login"> 
            <div class="wrapper"> 
                <div class="box-content"> 
                    <form action="upload.php" method="POST" class="form" style="width:460px;" enctype="multipart/form-data"> 
                        <div class="container"> 
                            <h2 class="title" style="text-align: center">Font</h2> 
                            <div class="row"> 
                            ...
                            <div class="row"> 
                                <div class="label"> 
                                    <label for="login-input">Choose Font File</label> 
                                </div> 
                                <div class="control"> 
                            ...
                            <div class="row"> 
                            <div class="control"> 
                                <button type="submit" class="button" name="submit">Submit</button> <!-- name="submit" -->
                            </div> 
                            </div> 
                        </div> 
                    </form> 
