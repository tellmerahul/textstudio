                      ...
                      <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><span class="badge badge-success badge-pill"><?php echo $row['status']; ?></span></td>
                            <td><?php echo $row['addon']; ?></td>
                            <td ><div class="fa-hover col-md-3 col-sm-4"><a href="delete_banner.php?id=<?php echo $row['id'] ?>"><i class="fa fa-trash-alt"></i></a></div>
