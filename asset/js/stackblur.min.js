!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).StackBlur = {})
}(this, (function(t) {
    "use strict";
    function e(t) {
    ...
    function a(t, r, n, a, o) {
        if ("string" == typeof t && (t = document.getElementById(t)),
        !t || "object" !== e(t) || !("getContext"in t))
            throw new TypeError("Expecting canvas with `getContext` method in processCanvasRGB(A) calls!");
        var i = t.getContext("2d");
        try {
            return i.getImageData(r, n, a, o)
        } catch (t) {
            throw new Error("unable to access image data: " + t)
        }
    }
    function o(t, e, r, n, o, f) {
        if (!(isNaN(f) || f < 1)) {
            f |= 0;
            var g = a(t, e, r, n, o);
            g = i(g, e, r, n, o, f),
            t.getContext("2d").putImageData(g, e, r)
        }
    }
    function i(t, e, a, o, i, f) {
        for (var g, c = t.data, u = 2 * f + 1, s = o - 1, v = i - 1, b = f + 1, x = b * (b + 1) / 2, d = new l, p = d, y = 1; y < u; y++)
            p = p.next = new l,
            y === b && (g = p);
        p.next = d;
        for (var h = null, m = null, w = 0, B = 0, C = r[f], I = n[f], S = 0; S < i; S++) {
            p = d;
            for (var E = c[B], N = c[B + 1], R = c[B + 2], j = c[B + 3], D = 0; D < b; D++)
                p.r = E,
                p.g = N,
                p.b = R,
                p.a = j,
                p = p.next;
            for (var G = 0, T = 0, A = 0, H = 0, O = b * E, W = b * N, k = b * R, M = b * j, _ = x * E, L = x * N, P = x * R, q = x * j, z = 1; z < b; z++) {
                var F = B + ((s < z ? s : z) << 2)
                  , J = c[F]
                  , K = c[F + 1]
                  , Q = c[F + 2]
        ...
        for (var ot = 0; ot < o; ot++) {
            var it = c[B = ot << 2]
              ...
              , pt = x * lt;
            p = d;
            for (var yt = 0; yt < b; yt++)
                p.r = it,
                p.g = ft,
                p.b = gt,
                p.a = lt,
                p = p.next;
            for (var ht = o, mt = 0, wt = 0, Bt = 0, Ct = 0, It = 1; It <= f; It++) {
                B = ht + ot << 2;
                var St = b - It;
                bt += (p.r = it = c[B]) * St,
                xt += (p.g = ft = c[B + 1]) * St,
            ...
            for (var Et = 0; Et < i; Et++) {
                ...
                c[Nt] = (bt * C >>> I) * lt,
                c[Nt + 1] = (xt * C >>> I) * lt,
                c[Nt + 2] = (dt * C >>> I) * lt) : c[Nt] = c[Nt + 1] = c[Nt + 2] = 0,
                bt -= ct,
                xt -= ut,
                dt -= st,
                pt -= vt,
    ...
    function g(t, e, a, o, i, f) {
        for (var g, c = t.data, u = 2 * f + 1, s = o - 1, v = i - 1, b = f + 1, x = b * (b + 1) / 2, d = new l, p = d, y = 1; y < u; y++)
            p = p.next = new l,
            y === b && (g = p);
        p.next = d;
        for (var h, m, w = null, B = null, C = r[f], I = n[f], S = 0, E = 0, N = 0; N < i; N++) {
            var R = c[E]
              , j = c[E + 1]
              , D = c[E + 2]
              , G = b * R
        ...
        for (var z = 0; z < o; z++) {
            ...
            for (var $ = 0; $ < b; $++)
                ...
                p.b = K,
                p = p.next;
            for (var tt = 0, et = 0, rt = 0, nt = 1, at = o; nt <= f; nt++)
                E = at + z << 2,
                X += (p.r = F = c[E]) * (m = b - nt),
                Y += (p.g = J = c[E + 1]) * m,
                Z += (p.b = K = c[E + 2]) * m,
    ...
    t.canvasRGB = f,
    t.canvasRGBA = o,
    t.image = function(t, e, r, n, a, i) {
        if ("string" == typeof t && (t = document.getElementById(t)),
        t && ("HTMLImageElement" !== Object.prototype.toString.call(t).slice(8, -1) || "naturalWidth"in t)) {
            var g = a ? "offset" : "natural"
              , l = t[g + "Width"]
              , c = t[g + "Height"];
            if ("ImageBitmap" === Object.prototype.toString.call(t).slice(8, -1) && (l = t.width,
            c = t.height),
            "string" == typeof e && (e = document.getElementById(e)),
            e && "getContext"in e) {
                i || (e.style.width = l + "px",
                e.style.height = c + "px"),
                e.width = l,
                e.height = c;
                var u = e.getContext("2d");
                u.clearRect(0, 0, l, c),
                u.drawImage(t, 0, 0, t.naturalWidth, t.naturalHeight, 0, 0, l, c),
                isNaN(r) || r < 1 || (n ? o(e, 0, 0, l, c, r) : f(e, 0, 0, l, c, r))
            }
        }
    }
    ,
