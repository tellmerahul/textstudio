!function(e) {
    if ("object" == typeof exports && "undefined" != typeof module)
        ...
        ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).GIF = e()
    }
}(function() {
    return function e(t, n, i) {
        ...
        1: [function(e, t, n) {
            ...
            i.prototype.addListener = function(e, t) {
                ...
                s(this._events[e]) && !this._events[e].warned && (n = o(this._maxListeners) ? i.defaultMaxListeners : this._maxListeners) && n > 0 && this._events[e].length > n && (this._events[e].warned = !0,
        ...
        2: [function(e, t, n) {
            ...
            s = "ie" === (i = a.match(/(opera|ie|firefox|chrome|version)[\s\/:]([\w\d\.]+)?.*?(safari|version[\s\/:]([\w\d\.]+)|$)/) || [null, "unknown", 0])[1] && document.documentMode,
            (r = {
                name: "version" === i[1] ? i[3] : i[1],
                version: s || parseFloat("opera" === i[1] && i[4] ? i[4] : i[2]),
                platform: {
                    name: a.match(/ip(?:ad|od|hone)/) ? "ios" : (a.match(/(?:webos|android)/) || o.match(/mac|win|linux/) || ["other"])[0]
                }
            })[r.name] = !0,
        ...
        , {}],
        3: [function(e, t, n) {
            var i, r, s, o = {}.hasOwnProperty, a = [].indexOf || function(e) {
            ...
            r = function(e) {
                ...
                r.prototype.addFrame = function(e, t) {
                    ...
                    n)
                        i[r] = t[r] || n[r];
                    if (null == this.options.width && this.setOption("width", e.width),
                    null == this.options.height && this.setOption("height", e.height),
                    "undefined" != typeof ImageData && null !== ImageData && e instanceof ImageData)
                        i.data = e.data;
                    else if ("undefined" != typeof CanvasRenderingContext2D && null !== CanvasRenderingContext2D && e instanceof CanvasRenderingContext2D || "undefined" != typeof WebGLRenderingContext && null !== WebGLRenderingContext && e instanceof WebGLRenderingContext)
                        t.copy ? i.data = this.getContextData(e) : i.context = e;
                    else {
                ...
                r.prototype.render = function() {
                    ...
                    this.imageParts = function() {
                        ...
                        for (n = [],
                        e = 0,
                        t = this.frames.length; 0 <= t ? e < t : e > t; 0 <= t ? ++e : --e)
                            n.push(null);
                        return n
                    }
                    .call(this),
                ...
                r.prototype.spawnWorkers = function() {
                    ...
                    function() {
                        n = [];
                        for (var i = t = this.freeWorkers.length; t <= e ? i < e : i > e; t <= e ? i++ : i--)
                            n.push(i);
                        return n
                    }
                    .apply(this).forEach((i = this,
                    function(e) {
                        var t;
                        return i.log("spawning worker " + e),
                        (t = new Worker(i.options.workerScript)).onmessage = function(e) {
                            return i.activeWorkers.splice(i.activeWorkers.indexOf(t), 1),
                ...
                r.prototype.frameFinished = function(e) {
                    ...
                    !0 === this.options.globalPalette && (this.options.globalPalette = e.globalPalette,
                    this.log("global palette analyzed"),
                    this.frames.length > 2))
                        for (t = 1,
                        n = this.freeWorkers.length; 1 <= n ? t < n : t > n; 1 <= n ? ++t : --t)
                            this.renderNextFrame();
                    return a.call(this.imageParts, null) >= 0 ? this.renderNextFrame() : this.finishRendering()
                }
                ,
                r.prototype.finishRendering = function() {
                    var e, t, n, i, r, s, o, a, h, l, f, p, u, c, d, v;
                    for (a = 0,
                    r = 0,
                    h = (c = this.imageParts).length; r < h; r++)
                        a += ((t = c[r]).data.length - 1) * t.pageSize + t.cursor;
                    for (a += t.pageSize - t.cursor,
                    this.log("rendering finished - filesize " + Math.round(a / 1e3) + "kb"),
                    e = new Uint8Array(a),
                    p = 0,
                    s = 0,
                    l = (d = this.imageParts).length; s < l; s++)
                        for (n = o = 0,
                        f = (v = (t = d[s]).data).length; o < f; n = ++o)
                            u = v[n],
                            e.set(u, p),
                            n === t.data.length - 1 ? p += t.cursor : p += t.pageSize;
                    return i = new Blob([e],{
                        type: "image/gif"
                    }),
                ...
                r.prototype.renderNextFrame = function() {
                    ...
                    if (!(this.nextFrame >= this.frames.length))
                        return e = this.frames[this.nextFrame++],
                ...
                r.prototype.log = function() {
                    var e;
                    if (e = 1 <= arguments.length ? h.call(arguments, 0) : [],
                    this.options.debug)
