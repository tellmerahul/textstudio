    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 11,
                "vtp_instanceDestinationId": "G-8RG2FQF6VS",
                "tag_id": 17
            }, {
        ...
        ,
        "security_groups": {
            "google": ["__c", "__ccd_conversion_marking", "__ccd_em_download", "__ccd_em_form", "__ccd_em_outbound_click", "__ccd_em_page_view", "__ccd_em_scroll", "__ccd_em_site_search", "__ccd_em_video", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__e", "__ogt_1p_data_v2", "__set_product_settings"
            ]
...
*/
    ...
    function zc(a) {
        var b = E.createElement("div"), c = b, d, e = ec("A<div>" + a + "</div>"), f = Hb();
...
*/
    var Rc = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/
      ...
      , Vc = function(a, b) {
        var c = b || (Sc(a) == "array" ? [] : {}), d;
        for (d in a)
            if (Tc(a, d)) {
                var e = a[d];
                Sc(e) == "array" ? (Sc(c[d]) != "array" && (c[d] = []),
    ...
    function Wc(a) {
        if (a == void 0 || Array.isArray(a) || Uc(a))
            return !0;
        switch (typeof a) {
        case "boolean":
        case "number":
    ...
    ;var Yc = function(a) {
        ...
        this.la = !1;
        for (var b in a)
            a.hasOwnProperty(b) && (Xc(b) ? this.values[Number(b)] = a[Number(b)] : this.R.set(b, a[b]))
    };
    h = Yc.prototype;
    h.toString = function(a) {
        ...
        for (var b = [], c = 0; c < this.values.length; c++) {
            var d = this.values[c];
            d === null || d === void 0 ? b.push("") : d instanceof Yc ? (a = a || [],
            a.push(this),
            b.push(d.toString(a)),
    ...
    h.set = function(a, b) {
        if (!this.la)
            if (a === "length") {
                ...
                Xc(a) ? this.values[Number(a)] = b : this.R.set(a, b)
    }
    ;
    h.get = function(a) {
    ...
    ;var jd = {
        ...
        reverse: function() {
            for (var a = Zc(this), b = a.length - 1, c = 0; b >= 0; b--,
            c++)
    ...
    function Id(a, b, c) {
        ...
        if (id())
            throw new kd("The value is not iterable.");
    ...
    function Pd(a, b) {
        ...
        if (a instanceof La || a instanceof gd || a instanceof Yc || a instanceof $c)
            c = a.get(b);
    ...
    function ze(a, b, c, d, e) {
        ...
        try {
            ...
            if (!(r instanceof kd && a))
                throw f = r instanceof kd,
                r;
            var k = Ha(this.D)
              , m = new ed(r);
            k.add(b, m);
    ...
    ;
    function Ee(a) {
        if (a instanceof Ba || a instanceof $c || a instanceof Yc || a instanceof La || a instanceof gd || a instanceof ed || a === null || a === void 0 || typeof a === "string" || typeof a === "number" || typeof a === "boolean")
            return a
    }
    ;var Ge = function(a) {
        this.message = a
    ...
    var yf = function(a, b, c) {
      ...
      , Bf = function(a, b) {
        ...
        if (!c)
            throw Error("Error: No function name given for function call.");
        var e = of[c], f = b && b.type === 2 && (d == null ? void 0 : d.reportMacroDiscrepancy) && e && uf.indexOf(c) !== -1, g = {}, k = {}, m;
        for (m in a)
        ...
        Wc(v) ? (Array.isArray(v) ? Array.isArray(t) : Uc(v) ? Uc(t) : typeof v === "function" ? typeof t === "function" : v === t) || d.reportMacroDiscrepancy(d.id, c) : v !== t && d.reportMacroDiscrepancy(d.id, c),
    ...
    ;var Tf = function() {
        ...
        ib(a, function(g, k) {
            function m(p) {
                ...
                if (!n[p])
                    throw Rf(p, {}, "The requested additional permission " + p + " is not configured.");
            ...
            c.C[g] = function(p, q) {
                var r = n[p];
                if (!r)
                    throw Rf(p, {}, "The requested permission " + p + " is not configured.");
    ...
    function K(a, b, c) {
        for (var d = 0; d < b.length; d++) {
            ...
            if (m == null) {
                ...
                if (n !== k)
                    throw Error("Error in " + a + ". Argument " + f + " has type " + ((Dg[n] || n) + ", which does not match required type ") + ((Dg[k] || k) + "."));
            }
        }
    }
    ;function Eg(a) {
    ...
    hh.entries = function(a) {
        ...
        if (a instanceof Yc || a instanceof $c || typeof a === "string")
            a = ih(a);
        if (a instanceof La || a instanceof gd)
            return new Yc(a.Cb().map(function(b) {
                return new Yc(b)
            }));
        return new Yc
    }
    ...
    function Hh(a, b) {
        if (a) {
            var c = a.split("x");
            c.length === 2 && (Ih(b, "u_w", c[0]),
            Ih(b, "u_h", c[1]))
        }
    }
    function Jh(a, b) {
        a && (a.length === 2 ? Ih(b, "hl", a) : a.length === 5 && (Ih(b, "hl", a.substring(0, 2)),
        Ih(b, "gl", a.substring(3, 5))))
    }
    function Kh(a) {
        var b = Lh;
        b = b === void 0 ? Mh : b;
    ...
    Hi)
      , Ii = {}
      , ti = (Ii.email = "sha256_email_address",
    ...
    Ki.Ce = Number("0") || 0;
    Ki.ob = "dataLayer";
    Ki.Dn = "ChEIgK+wugYQ5ouJ25uswLu5ARIlACv1iPTkCnZWFIjUqkG15Pqs6b75RGjeLGn4rDnuXR1/bQaXrxoC0yc\x3d";
    var Mi = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    function qj(a, b) {
        lj.hasOwnProperty(a) || (jj.set(a, b),
        Vc(yb(a, b), kj),
        mj())
    }
    function rj() {
    ...
    ;var gk = {}
      ...
      , Qf = {
        ctid: "G-8RG2FQF6VS",
        canonicalContainerId: "97184127",
        tk: "G-8RG2FQF6VS|GT-P3MFS7Q",
        uk: "G-8RG2FQF6VS"
    };
    gk.ze = mb("");
    function ik() {
    ...
    function wk() {
        ...
        if (a) {
            ...
            if (b.siloed) {
                ...
                g++)
                    f.ig = b.siloed[g],
                    !hk && eb(f.ig.isDestination ? e : d, function(k) {
                        return function(m) {
                            return m === k.ig.ctid
                        }
                    }(f)) ? hk = !0 : c.push(f.ig);
    ...
    function xk() {
        ...
        if (a.pending) {
            ...
            k++)
                g.hf = a.pending[k],
                eb(g.hf.target.isDestination ? f : e, function(m) {
                    return function(n) {
    ...
    function yk() {
        for (var a = Qf.ctid, b = kk(), c = nk(), d = function(n, p) {
            ...
            var T = p ? e.destination : e.container
              , M = T[n];
            M ? (p && M.state === 0 && V(93),
            Object.assign(M, q)) : T[n] = q
        }, e = dk(), f = l(b), g = f.next(); !g.done; g = f.next())
            d(g.value, !1);
    ...
    var Xk = !1
      ...
      , $k = {
        ...
        containerScopedDefaults: (Zk.ad_storage = 1,
    ...
    function el() {
        ...
        for (var b = l(Object.keys($k.containerScopedDefaults)), c = b.next(); !c.done; c = b.next())
            if ($k.containerScopedDefaults[c.value] !== 1)
                return !0;
        return !1
    }
    function fl(a, b) {
    ...
    ;var pl;
    try {
        pl = JSON.parse(Ta("eyIwIjoiSU4iLCIxIjoiSU4tSFIiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jby5pbiIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        V(123),
        ol(2),
        pl = {}
    ...
    var xl = [O.g.O, O.g.U, O.g.N, O.g.Aa], yl, zl;
    function Al(a) {
    ...
    function Cl(a) {
        ...
        if (b) {
            ...
            if (!c.includes(rl()) && !c.includes(ql()))
                return
        }
        ib(a, function(d, e) {
            switch (d) {
    ...
    function El(a) {
        a.hasOwnProperty("all") && ($k.selectedAllCorePlatformServices = !0,
        ib(Fh, function(b) {
            $k.corePlatformServices[b] = a.all === "granted";
            $k.usedCorePlatformServices = !0
        }));
        ib(a, function(b, c) {
            b !== "all" && ($k.corePlatformServices[b] = c === "granted",
            $k.usedCorePlatformServices = !0)
        })
    }
    function X(a) {
    ...
    ;function Ul() {
        if (Li.pscdl !== void 0)
            Rl(Ml.wf) === void 0 && Ql(Ml.wf, Li.pscdl);
        else {
            var a = function(c) {
                Li.pscdl = c;
                Ql(Ml.wf, c)
            ...
            if (!(e && e.length > 1)) {
                ...
                for (n in f)
                    if (f.hasOwnProperty(n)) {
                        var p = mm(f[n], k);
                        p.length && (im && console.log(p),
                        m.push(n))
                    }
                m.length && (km(b, m),
                Va("TAGGING", fm[E.readyState] || 14));
                f[b] = k
            }
        }
    }
    ...
    function om() {
        Kk("tdc", function() {
            jm && (B.clearTimeout(jm),
            jm = void 0);
            var a = [], b;
            for (b in dm)
                dm.hasOwnProperty(b) && a.push(b + "*" + dm[b].join("."));
    ...
    ;var pm = function(a, b, c, d, e, f, g, k, m, n, p) {
      ...
      , W = function(a, b, c, d) {
        for (var e = l(qm(a, d === void 0 ? 3 : d)), f = e.next(); !f.done; f = e.next()) {
            var g = f.value;
            if (g[b] !== void 0)
                return g[b]
        }
      ...
      , tm = function(a) {
        for (var b = [O.g.Zc, O.g.Vc, O.g.Wc, O.g.Xc, O.g.Yc, O.g.bd, O.g.dd], c = qm(a, 3), d = l(c), e = d.next(); !e.done; e = d.next()) {
    ...
    function Vm() {
        return [["v", "3"], ["t", "t"], ["pid", String(Tm)]]
    }
    var Wm = {};
    function Xm(a, b, c) {
        Vj && a !== void 0 && (Wm[a] = Wm[a] || [],
        Wm[a].push(c + b),
        Sm(a))
    }
    function Ym(a) {
    ...
    function an(a, b, c, d) {
        ...
        e && (R(51) && Qi && (d.deferrable = !0),
        $m.push("event", [b, a], e, d))
    }
    function bn(a, b, c, d) {
        var e = Yl(c, d.isGtmEvent);
    ...
    hn.prototype.push = function(a, b, c, d) {
        c !== void 0 && (dn(this, c).status === 1 && (dn(this, c).status = 2,
        this.push("require", [{}], c, {})),
    ...
    hn.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.commands.length; e = {
            ...
            if (f.messageContext.deferrable)
                !g || dn(this, g).H ? (f.messageContext.deferrable = !1,
                ...
                case "config":
                    ...
                    k.H = !0;
                    n ? Vc(e.Jc, k.K) : (Vc(e.Jc, k.P[g.id]),
                    V(70));
                    d = !0;
                    break;
                case "event":
    ...
    var Fn = function(a, b, c, d) {
      ...
      , In = /[?&]($|#)/
      , Jn = function(a, b, c) {
        for (var d, e = a.search(Gn), f = 0, g, k = []; (g = Fn(a, f, b, e)) >= 0; )
    ...
    var Nn = function(a) {
      ...
      , Pn = function(a) {
        ...
        if (a === void 0 ? 0 : a) {
            ...
            if (b)
                return b[b.length - 1] == B.location.origin ? 1 : 2
        }
        return Nn(B.top) ? 1 : 2
    }
      , Qn = function(a) {
    ...
    Xn.prototype.Ua = function() {
        this.aa = {};
        this.K && (on(this.H, "message", this.K),
        delete this.K);
        delete this.aa;
        delete this.H;
        delete this.j;
    ...
    var bo = function(a, b, c) {
        ...
        if (k === 0)
            ...
            m = k === 1 ? a.purpose && a.vendor ? ao(a.purpose.legitimateInterests, b) && ao(a.vendor.legitimateInterests, d === void 0 ? "755" : d) : !0 : !0;
        return m
    }
      , ao = function(a, b) {
        return !(!a || !a[b])
                ...
                b.addEventListener(function(c) {
                    ...
                    !uo(c) || ro() || so()) {
                        ...
                        if (d) {
                            ...
                            q);
                            a.gdprApplies !== !0 ? (Jl([O.g.O, O.g.Aa, O.g.N]),
                            Tk().active = !0) : (r[O.g.Aa] = a.uc["3"] && a.uc["4"] ? "granted" : "denied",
                            typeof a.tcfPolicyVersion === "number" && a.tcfPolicyVersion >= 4 ? r[O.g.N] = a.uc["1"] && a.uc["7"] ? "granted" : "denied" : Jl([O.g.N]),
                            Dl(r, {
                                eventId: 0
                            }, {
    ...
    function Co(a) {
        if (rl() === "US-CO" && gc.globalPrivacyControl === !0)
            return !1;
        var b = Bo(a);
        if (b === 3)
            return !1;
    ...
    function Eo() {
        var a = {}, b;
        for (b in Ao)
            Ao.hasOwnProperty(b) && (a[Ao[b]] = bl(b));
    ...
    function Io(a) {
        for (var b = "1", c = 0; c < yo.length; c++) {
            var d = b, e, f = yo[c], g = $k.delegatedConsentTypes[f];
    ...
    function Qo(a) {
        ...
        Ri ? (c.rg = Po[b],
        c.rg || (c.rg = 0)) : c.rg = Vi ? 13 : 10;
        ej.C ? (c.pg = 0,
        c.Ol = 2) : Ti ? c.pg = 1 : Oo() ? c.pg = 2 : c.pg = 3;
        var e = {};
        e[6] = hk;
        ...
        m === void 0 ? k = "" : (n || (n = 0),
        k = "" + Ke(1, 1) + He(m << 2 | n));
        var p = c.Ol, q = "4" + k + (p ? "" + Ke(2, 1) + He(p) : ""), r, u = c.mn;
        ...
        if (x && g) {
            ...
            w = "";
        var D = c.rn, G = c.Ke, J = c.qa, F = c.no, T = q + r + v + w + (D ? "" + Ke(6, 1) + He(D) : "") + (G ? "" + Ke(7, 3) + He(G.length) + G : "") + (J ? "" + Ke(8, 3) + He(J.length) + J : "") + (F ? "" + Ke(9, 3) + He(F.length) + F : ""), M;
        var aa = c.Rl;
        aa = aa === void 0 ? {} : aa;
    ...
    function $p(a, b) {
        var c = b.split(".");
        c.length === 5 ? (Sp[a] = c.slice(0, 2).join("."),
        Tp[a] = {
            id: c.slice(2, 4).join("."),
            Zh: Number(c[4]) || 0
        }) : c.length === 3 ? Tp[a] = {
    ...
    ;var lq = new Map([[5, "ad_storage"], [4, ["ad_storage", "ad_user_data"]]]);
    function mq(a) {
        if (iq[5]) {
    ...
    function Vq(a, b, c, d, e, f) {
        ...
        c && k(c, "dc");
        d !== void 0 && xq.test(d) && (g.wbraid = d,
        k(d, "gb"));
        e !== void 0 && xq.test(e) && (g.gbraid = e,
        k(e, "ag"));
        f !== void 0 && xq.test(f) && (g.gad_source = f,
        k(f, "gs"));
        return g
    }
    function Xq(a) {
    ...
    function Yq(a, b, c, d, e) {
        ...
        var f = Hq(c.prefix)
          ...
          , q = function() {
            ...
            if (!p && a.gbraid && Bq("ad_storage") && (p = !0,
            !n)) {
                var C = a.gbraid
                  , D = Iq("ag", f);
    ...
    function $q(a, b, c, d) {
        if (a.gad_source !== void 0 && Bq("ad_storage")) {
            ...
            var f = a.gad_source
              , g = Iq("gs", b);
            if (g) {
                var k = Math.round((qb() - (Hc() || 0)) / 1E3), m;
                if ($a(11)) {
                    var n, p = String, q = B.location.hostname, r = B.location.pathname, u = q = Ij(q);
        ...
        if (So(B)) {
            ...
            Cq(function() {
                ib(d, function(f, g) {
                    ...
                    if (k.length) {
                        var m = k[0], n = br(m), p = dr(m.split(".")).length !== 0 ? m.split(".").slice(3) : [], q = {}, r;
    ...
    ;var sr = function(a, b) {
            ...
            vr(function() {
                ...
                if (v) {
                    ...
                    if (C.length !== 0 || r !== void 0) {
                        ...
                        if (!c) {
                            var F = {};
                            c = Fm(vm(new um(0), (F[O.g.na] = $m.j[O.g.na],
                            F)))
                        }
                        t.push("gtm=" + Qo({
                            qa: b
      ...
      , ur = function() {
        var a = Gj(B.location.href), b = void 0, c = void 0, d = Aj(a, "query", !1, void 0, "gad_source"), e, f = a.hash.replace("#", "").match(Cr);
        e = f ? f[1] : void 0;
        d && e ? (b = d,
        c = 1) : d ? (b = d,
        c = 2) : e && (b = e,
    ...
    function Ur(a) {
        var b = $a(11), c = {}, d, e, f;
        Or.test(E.location.host) && (d = Tr("gclgs"),
        e = Tr("gclst"),
        b && (f = Tr("gcllp")));
        if (d && e && (!b || f))
            c.Nh = d,
            ...
            m.length > 0 && n.length > 0 && (!b || p.length > 0) && (c.Nh = m.join("."),
            c.Ph = n.join("."),
    ...
    ;var es = function(a) {
            ...
            if (R(21)) {
                ...
                if (e)
                    ...
                    if (a.metadata.consent_updated)
                        ...
                        a.j[O.g.be] = k.dclid;
                        a.j[O.g.Xi] = k.gclsrc;
                        a.j[O.g.Td] || a.j[O.g.be] || (a.j[O.g.Bf] = k.wbraid,
                        a.j[O.g.Dg] = k.gbraid);
                    ...
                    kl = !0;
                    var r = X([O.g.O, O.g.N]);
                    r && (R(25) && (a.j[O.g.ib] = ds()),
                    c && (Up(b),
                    a.j[O.g.Lb] = Sp[Vp(b.prefix)]));
                    a.j[O.g.rb] = void 0;
                    a.j[O.g.Za] = void 0;
      ...
      , cs = function(a) {
        ...
        d = a.Pd;
        e = a.rc;
        b && (Qp(c[O.g.Hc], !!c[O.g.X]) && (ar(gs, e),
        cr(e),
        bq(e)),
        R(92) || R(120) ? Zq(e) : Xq(e),
        gr(gs, e),
        hr(e));
        c[O.g.X] && (er(gs, c[O.g.X], c[O.g.Pb], !!c[O.g.yb], e.prefix),
    ...
    function ks(a) {
        var b = W(a.m, O.g.Ob)
          , c = W(a.m, O.g.jc);
        b && !c ? (a.eventName !== O.g.ba && a.eventName !== O.g.Uc && V(131),
        a.isAborted = !0) : !b && c && (V(132),
        a.isAborted = !0)
    }
    function ls(a) {
    ...
    function Iu(a, b) {
        ...
        var k = g, m = ((k == null ? void 0 : k.length) || 0) >= (Za[2] === void 0 ? 50 : Za[2]), n;
        if (n = e.length >= 1) {
            var p = Number(e[e.length - 1].dataset.loadTime);
            p !== void 0 && qb() - p < (Za[1] === void 0 ? 6E4 : Za[1]) ? (Va("TAGGING", 9),
            n = !0) : n = !1
        }
        if (!n) {
            if (c === 1)
    ...
    ;var Dv = function(a, b) {
        ...
        ib(a.j, function(f, g) {
            var k = Cv[f];
            k && g !== void 0 && g !== "" && (!a.metadata.redact_click_ids || f !== O.g.Td && f !== O.g.be && f !== O.g.Bf && f !== O.g.Dg || (g = "0"),
            d(k, g))
        });
        d("gtm", Qo({
    ...
    ;function Aw(a, b, c, d) {
        ...
        var m = Jn(a, "fmt", 4);
        qc(m, function() {
            B.google_noFurtherRedirects && b && (B.google_noFurtherRedirects = null,
            b())
    ...
    function dx() {
        ...
        $w.test(B.location && B.location.hostname) && (Ri ? V(116) : (V(117),
        ex && (a = [],
        ...
        c ? V(8) : c = [];
        $w.test(B.location && B.location.hostname) && (c = nb(c),
        ...
        return function(f) {
            ...
            var v = !m || q;
            v || !(k.indexOf("sandboxedScripts") >= 0) || b && b.indexOf("sandboxedScripts") !== -1 || (v = gb(d, cx));
            return e[g] = v
        }
    }
    var ex = !1;
        ...
        if (!hx()) {
            ...
            if (!zk(f)) {
                ...
                if (R(74) && hj())
                    ...
                    if (!q) {
                        var r = Ki.xf + p;
                        n && jc && m ? (r = jc.replace(/^(?:https?:\/\/)?/i, "").split(/[?#]/)[0],
                        q = vs("https://", "http://", r + k)) : q = hj() ? gj() + "/" + k : vs("https://", "http://", r + k)
                    }
                    qc(q)
                }
            }
            ...
            if (!Ak(e))
                ...
                R(74) && hj())
                    ...
                    var f = "/gtag/destination" + ix(a, !0)
                      , g = Lj(b, f);
                    g || (hj() ? (f = "/gtd" + ix(a, !0),
                    g = gj() + f) : g = vs("https://", "http://", Ki.xf + f));
                    qc(g)
                }
        }
    }
    ...
    ;var tx = function(a, b) {
      ...
      , ux = function(a, b, c, d) {
        if (Ni.hasOwnProperty(b) || b === "__zone")
            return -1;
        var e = {};
        Uc(d) && (e = Vc(d, e));
        e.id = c;
    ...
    ;var Px = {}
      ...
      , Rx = {};
    function Sx(a, b, c, d) {
        Vj && R(98) && ((d === void 0 ? 0 : d) ? (Rx[b] = Rx[b] || 0,
        ++Rx[b]) : c !== void 0 ? (Qx[a] = Qx[a] || {},
        Qx[a][b] = Math.round(c)) : (Px[a] = Px[a] || {},
        Px[a][b] = (Px[a][b] || 0) + 1))
    }
    function Tx(a) {
        var b = a.eventId, c = a.Tc, d = Px[b] || {}, e = [], f;
        for (f in d)
    ...
    function Ux(a) {
        var b = a.eventId, c = a.Tc, d = Qx[b] || {}, e = [], f;
        for (f in d)
            d.hasOwnProperty(f) && e.push("" + f + d[f]);
        c && delete Qx[b];
    ...
    function py(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                ...
                if (Mi[d] || mf[c][Le.Dl] !== void 0 || Tw(d, 2))
                    b[c] = !0
            }
        return b
    }
    function qy(a, b) {
        if (!b)
            return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && mf[c] && !Ni[String(mf[c][Le.ra])])
                return !0;
        return !1
    }
    var ry = 0;
    ...
    var hz = [O.g.rd, O.g.Sb, O.g.Dc, O.g.tb, O.g.zb, O.g.Da, O.g.xa, O.g.Na, O.g.Ra, O.g.vb]
      , iz = {
                ...
                if (e) {
                    ...
                    if (u ? nk().indexOf(r) === -1 : kk().indexOf(r) === -1) {
                        ...
                        b.inheritParentConfig)) {
                            ...
                            var x = d;
                            ez ? (fz(b, ez, x),
                            w = !1) : (!x[O.g.nc] && Pi && dz || (dz = Vc(x, null)),
                            w = !0);
        ...
        consent: function(a, b) {
            if (a.length === 3) {
                ...
                var c = cz(a, b)
                  , d = a[1]
                  , e = a[2];
                b.fromContainerExecution || (e[O.g.N] && V(139),
                e[O.g.Aa] && V(140));
                d === "default" ? Bl(e) : d === "update" ? Dl(e, c) : d === "declare" && b.fromContainerExecution && Al(e)
            }
        },
        event: function(a, b) {
            var c = a[1];
        ...
        set: function(a, b) {
            var c = void 0;
            a.length === 2 && Uc(a[1]) ? c = Vc(a[1], null) : a.length === 3 && z(a[1]) && (c = {},
            Uc(a[2]) || Array.isArray(a[2]) ? c[a[1]] = Vc(a[2], null) : c[a[1]] = a[2]);
            if (c) {
                var d = cz(a, b)
                  , e = d.eventId
                  , f = d.priorityId;
    ...
    function Az(a, b) {
        ...
        if (!a.event)
            return !1;
        typeof d !== "number" && (d = bj(),
        a["gtm.uniqueEventId"] = d,
        qj("gtm.uniqueEventId", d));
        return my(a)
    }
    function Bz(a) {
    ...
    ;function rA() {
        var a = [["cv", R(119) ? qA() : "1"], ["rv", Ki.wh], ["tc", mf.filter(function(b) {
            return b
        }).length]];
    ...
    var TA = function(a, b, c) {
      ...
      , SA = function(a) {
        ...
        return VA.indexOf(b) < 0 || b === "input" && WA.indexOf(a.type.toLowerCase()) >= 0 ? !1 : !0
    }
    ...
    function mB(a, b) {
        ...
        if (!d || d < 0)
            d = 0;
        var e = I(a), f;
        MA("pix.fil", "init") ? f = MA("pix.fil", "reg") : (hB(),
        f = lB,
        NA("pix.fil", "reg", lB),
        NA("pix.fil", "init", !0));
        f(d, e);
    ...
    function pC(a) {
        ...
        }, this.D, vb(JA(this).kb(), "__cvt_") ? 2 : 1)
    }
    pC.T = "createQueue";
    function qC(a, b) {
        var c = null;
                ...
                if (g) {
                    ...
                    if (k) {
                        ...
                        if (m !== null && n !== null) {
                            var p = e[m];
                            p ? (p.Xb && (B.clearTimeout(p.Xb),
                            p.Eb.getAttribute("data-gtm-form-interact-field-id") !== n && PC(p, d)),
                            p.Eb = g,
                            SC(p, d, b)) : (e[m] = {
                                form: k,
                                Eb: g,
    ...
    function mD(a, b) {
        ...
        if (!MA(d, "init", !1)) {
            ...
            b = LA(b),
            hD(b, e),
            NA(d, "reg", hD)) : f = gD("gtm.historyChange");
            lD(f);
            kD(f);
            iD("pushState", f);
            iD("replaceState", f);
    ...
    var oD = function(a, b) {
      ...
      , pD = function(a, b) {
        for (var c = Aj(Gj((b.attributes && b.attributes.formaction ? b.formAction : "") || b.action || Gc(b, "href") || b.src || b.code || b.codebase || ""), "host"), d = 0; d < a.length; d++)
            try {
      ...
      , qD = function() {
        function a(c) {
            ...
            if (d && c.which !== 3 && !(c.j || c.timeStamp && c.timeStamp === b)) {
                ...
                if (!d)
                    return c.returnValue;
                var e = c.defaultPrevented || c.returnValue === !1, f = MA("lcl", e ? "nv.mwt" : "mwt", 0), g;
    ...
    var uD = function(a) {
      ...
      , xD = function(a, b) {
        MA("sdl", "init", !1) && !AD() && (b ? wc(B, "scrollend", a) : wc(B, "scroll", a),
        wc(B, "resize", a),
        NA("sdl", "init", !1))
    }
      , wD = function() {
      ...
      , AD = function() {
        return !!(Object.keys(uD("horiz.pix")).length || Object.keys(uD("horiz.pct")).length || Object.keys(uD("vert.pix")).length || Object.keys(uD("vert.pct")).length)
    };
    function ED(a, b) {
        var c = this;
        K(this.getName(), ["options:!PixieMap", "triggerId:?*"], arguments);
        ...
        MA("sdl", "init", !1) ? MA("sdl", "pending", !1) || H(function() {
            wD()
        }) : (NA("sdl", "init", !0),
        NA("sdl", "pending", !0),
        H(function() {
            ...
            if (AD()) {
                var e = zD();
                "onscrollend"in B ? (e = yD(),
                vc(B, "scrollend", e)) : vc(B, "scroll", e);
                vc(B, "resize", e)
            } else
                NA("sdl", "init", !1)
        }));
    ...
    function FD(a) {
        return function() {
            if (a.limit && a.bi >= a.limit)
                a.og && B.clearInterval(a.og);
            else {
                a.bi++;
                var b = qb();
                yz({
    ...
    var Zb = wa(["data-gtm-yt-inspected-"]), ID = ["www.youtube.com", "www.youtube-nocookie.com"], JD, KD = !1;
        ...
        function r() {
            if (v.length && y !== 0) {
                ...
                c = function() {
                    ...
                    yz(u.createEvent("progress", J.jf, J.nf)));
                    r()
                }
                ;
      ...
      , RD = function(a, b) {
        ...
        if (TD(c, "embed/")) {
            ...
            if (b) {
                var d;
                var e = c.indexOf("?") !== -1 ? "&" : "?";
                c.indexOf("origin=") > -1 ? d = c + e + "enablejsapi=1" : (JD || (JD = E.location.protocol + "//" + E.location.hostname,
    ...
    function UD(a, b) {
        ...
        H(function() {
            for (var u = E.getElementsByTagName("script"), v = u.length, t = 0; t < v; t++) {
                ...
                if (TD(w, "iframe_api") || TD(w, "player_api"))
                    return b
            }
            for (var x = E.getElementsByTagName("iframe"), y = x.length, A = 0; A < y; A++)
                if (!KD && RD(x[A], p.Re))
                    return qc("https://www.youtube.com/iframe_api"),
                    KD = !0,
                    b
        });
        return b
    ...
    function GF() {
        ...
        R(45) && FF ? a = FF : (a.set("containerId", 'G-8RG2FQF6VS'),
        a.set("version", '1'),
    ...
    var lG = function(a) {
        ...
        return !(!Fc() && gc.sendBeacon === void 0 || e || m || f || g || k || b || c || !d && kG)
    }
      , kG = !1;
    var mG = function(a) {
        var b = 0
    ...
    h.xl = function(a) {
        ...
        if (!this.j) {
            ...
            Tt(a) && !mc("Firefox") && !mc("FxiOS") && c(B, "beforeunload", function() {
                kG = !0
            });
            this.ni();
            this.C = 0
    ...
    ;var uG = function(a, b, c) {
      ...
      , wG = function(a, b) {
        var c = a.j[O.g.tb];
        if (W(a.m, O.g.Ob) && W(a.m, O.g.jc) || b && c === b)
            return c;
        if (c) {
            c = "" + c;
            if (!vG(c, a))
    ...
    var BG = function(a, b, c) {
        ...
        if (!d)
            return b;
        var e, f = lb((e = W(c.m, O.g.sd)) != null ? e : 30);
        if (!(Math.floor(c.metadata.event_start_timestamp_ms / 1E3) > d.df + f * 60))
            return a;
        var g = zG(b);
        if (!g)
            return a;
        g.Qc = d.Qc + 1;
        var k;
        return (k = AG(g.sessionId, g.Qc, g.Nd, g.df, g.Yh, g.Mc, g.Dd)) != null ? k : b
    }
      , EG = function(a, b) {
      ...
      , GG = function(a) {
        return AG(a.j[O.g.zb], a.j[O.g.te], a.j[O.g.se], Math.floor(a.metadata.event_start_timestamp_ms / 1E3), a.metadata.join_timer_sec || 0, !!a.metadata[O.g.Jf], a.j[O.g.ee])
    }
    ...
    var HG = function(a) {
      ...
      , NG = function(a) {
        var b = HG(a) || {}
          ...
          , e = CG(a, c)
          , f = {};
        Qp(b[O.g.Hc], !!b[O.g.X]) && (f = JG(a, d, e),
        f.clientId && f.Wa && (MG = !0));
        b[O.g.X] && Np(function() {
            var g = {}
              , k = yG(a);
            k && (g[d] = k);
    ...
    var OG = function(a) {
        if (!a.metadata.is_merchant_center && Nj(a.m)) {
            var b = HG(a) || {}
              , c = (Qp(b[O.g.Hc], !!b[O.g.X]) ? Gp(!0)._fplc : void 0) || (To("FPLC", void 0, void 0, O.g.U).length > 0 ? void 0 : "0");
            a.j._fplc = c
        }
    };
    function PG(a) {
    ...
    var TG = function(a) {
        if (W(a.m, O.g.ld) !== void 0)
            a.copyToHitData(O.g.ld);
        else {
            var b = W(a.m, O.g.Pf), c, d;
            a: {
                if (MG) {
                    var e = HG(a) || {};
                    if (e && e[O.g.X])
                        for (var f = Aj(Gj(a.j[O.g.Ga]), "host", !0), g = e[O.g.X], k = 0; k < g.length; k++)
            ...
            if (!(c = d)) {
                ...
                if (m = b)
                    a: {
                        for (var n = b.include_conditions || [], p = Aj(Gj(a.j[O.g.Ga]), "host", !0), q = 0; q < n.length; q++)
                            if (n[q].test(p)) {
                                m = !0;
                                break a
                            }
    ...
    cH)
      , eH = function(a, b, c) {
        ...
        d._p = R(134) ? Yi : sG();
        if (c && (c.Ld > 0 || c.mg) && (R(103) || (d.em = c.Gb),
        c.za)) {
            var g = c.za.Cd;
        ...
        ib(a.j, function(v, t) {
            if (t !== void 0 && !nh.hasOwnProperty(v)) {
                ...
                var w;
                var x = t;
                v !== O.g.ee ? w = !1 : a.metadata.euid_mode_enabled || Tt(a) ? (d.ecid = x,
                w = !0) : w = void 0;
                if (!w && v !== O.g.Jf) {
                    var y = t;
                    t === !0 && (y = "1");
                    ...
                    if (ZG[v])
                        ...
                        var C;
                        bH[v] ? C = !0 : v !== O.g.Zc ? C = !1 : (typeof t !== "object" && q(v, t),
                        C = !0);
                        C || q(v, t)
                    }
                }
        ...
        (function(v) {
            Tt(a) && typeof v === "object" && ib(v || {}, function(t, w) {
        ...
        ib(r, function(v, t) {
            t !== void 0 && ((t === null && (t = ""),
            v !== O.g.Da || f.uid) ? b[v] !== t && (e[(cb(t) ? "upn." : "up.") + String(v)] = String(t),
        ...
        for (var c = b.indexOf("\n\n"); c !== -1; ) {
            ...
            if (n) {
                ...
                if (p) {
                    var u = p || [];
                    if (Array.isArray(u))
                        for (var v = Uc(q) ? q : {}, t = l(u), w = t.next(); !w.done; w = t.next())
                            r(w.value, v)
                }
                ...
                if (x && A) {
                    var C = x || [];
                    if (Array.isArray(C))
                        for (var D = Uc(y) ? y : {}, G = l(C), J = G.next(); !J.done; J = G.next())
                            A(J.value, D)
                }
            }
            b = b.substring(c + 2);
    ...
    ;var jH = function(a, b) {
      ...
      , nH = function(a, b, c) {
        ...
        B.fetch(a, d).then(function(e) {
            ...
            R(107) && (a += "&_z=retryFetch",
            b ? Cc(a, b) : Bc(a))
        })
    }
      , oH = function(a, b) {
        return gH(new fH(function(c, d) {
            var e = jH(c, a);
    ...
    var rH = function(a, b) {
      ...
      , uH = function(a, b, c, d) {
        ...
        if (d && !kG)
            ...
            Fc() ? Ec(a + "?" + k, c, {
                noFallback: !0
            }) || sH(a, rH(k, "_z=failedfetch"), c) : sH(a, rH(k, "_z=nofetch"), c)
        }
    }
      , vH = function(a, b) {
        function c(v) {
    ...
    wH.prototype.flush = function() {
        if (this.C.events.length) {
            ...
            this.C = new ag;
            this.H >= 0 && (B.clearTimeout(this.H),
            this.H = -1)
        }
    }
    ;
    ...
    var AH = function(a, b, c) {
      ...
      , DH = function(a, b) {
        ...
        if (c.length) {
            var d = BH(c);
            Fl(c, function() {
                for (var e = BH(c), f = [], g = l(c), k = g.next(); !k.done; k = g.next()) {
                    var m = k.value;
                    !d[m] && e[m] && f.push(m);
                    e[m] && (d[m] = !0)
                }
      ...
      , IH = function(a) {
        R(127) && Tt(a) && W(a.m, O.g.Fa) !== !1 && Gu("join-ad-interest-group") && bb(gc.joinAdInterestGroup) && Pt(a, "flg", 1)
    }
      , JH = function(a) {
        Tt(a) && (a.metadata.speculative = !1)
    }
      , KH = function(a) {
        Tt(a) && (a.metadata.speculative && Pt(a, "sp", 1),
        a.metadata.is_syn && Pt(a, "syn", 1),
        a.metadata.em_event && (Pt(a, "em_event", 1),
        Pt(a, "sp", 1)))
    }
      , LH = function(a) {
        if (Tt(a)) {
    ...
    var TH = function(a, b) {
      ...
      , UH = function(a, b, c, d, e) {
        ...
        if (v)
            ...
            d.xm(a);
        else if (d.lm() > r || a.eventName === O.g.ac)
            u.Nd = !0;
        a.metadata.euid_mode_enabled ? W(a.m, O.g.Da) ? u.Mc = !0 : (u.Mc && !R(13) && (u.Dd = void 0),
        u.Mc = !1) : u.Mc = !1;
        var t = u.Dd;
    ...
    var VH = window
      ...
      , XH = function(a) {
        ...
        if (b && b.ioo && b.ioo() || WH.documentElement.hasAttribute("data-google-analytics-opt-out") || a && VH["ga-disable-" + a] === !0)
            return !0;
        try {
            var c = VH.external;
    ...
    var kI = function(a) {
      ...
      , lI = function(a) {
        gc && gc.loadPurpose === "preview" && (V(30),
        a.isAborted = !0)
    }
      , mI = function(a) {
        var b = {
      ...
      , oI = function(a) {
        ...
        else if (Qt(a, "ccd_add_1p_data", !1) || Qt(a, "ccd_add_ec_stitching", !1))
      ...
      , pI = function(a) {
        if (a.metadata.euid_mode_enabled && Qt(a, "ccd_add_1p_data", !1)) {
            ...
            if (wj(b)) {
                var c = W(a.m, O.g.Ha);
                c === null ? a.metadata.user_data_from_code = null : (b.enable_code && Uc(c) && (a.metadata.user_data_from_code = c),
                Uc(b.selectors) && !a.metadata.user_data_from_manual && (a.metadata.user_data_from_manual = uj(b.selectors)))
            }
        }
    }
      , qI = function(a) {
        if (R(77) && !R(76) && Qt(a, "ga4_ads_linked", !1) && a.eventName === O.g.ba) {
      ...
      , rI = function(a) {
        a.eventName === O.g.ba && (W(a.m, O.g.Oa, !0) ? (a.m.j[O.g.fa] && (a.m.H[O.g.fa] = a.m.j[O.g.fa],
        a.m.j[O.g.fa] = void 0,
        a.j[O.g.fa] = void 0),
      ...
      , tI = function(a) {
        ...
        Uc(b[O.g.Zc]) ? ib(b[O.g.Zc], function(d, e) {
      ...
      , uI = function(a) {
        if (!W(a.m, O.g.jc) || !W(a.m, O.g.Ob)) {
            ...
            b.call(a, c, d, aI);
            var p = a.copyToHitData, q = O.g.Ga, r;
            a: {
                ...
                if (Li.ga4_referrer_override !== void 0)
                    r = Li.ga4_referrer_override;
                else {
      ...
      , wI = function(a) {
        ...
        if (!(hj() || R(6) && Tt(a) || a.metadata.is_merchant_center || W(a.m, O.g.sb) === !1) && EE() && X(O.g.O)) {
            var b = Ut(a);
            (a.metadata.is_session_start || W(a.m, O.g.Wg)) && (a.metadata.create_dc_join = !!b);
      ...
      , CI = function(a) {
        if (W(a.m, O.g.Fa) !== !1 && Co(a.m)) {
            var b = Ut(a)
              , c = W(a.m, O.g.sb);
            b && c !== !1 && EE() && X(O.g.O) && al(O.g.N) && cl(["ads"]).ads && Hu() && (a.j[O.g.kh] = !0)
        }
    }
      , HI = function(a) {
        var b = W(a.m, O.g.Ob);
        ...
        var c = sk(tk());
        (b || Ek(c) || c && c.parent && c.context && c.context.source === 5) && oG(19)
    }
      , iI = function(a) {
        if (XH(a.target.destinationId))
            V(28),
            a.isAborted = !0;
        else if (R(122)) {
            var b = rk();
      ...
      , yI = function(a) {
        rh.hasOwnProperty(a.eventName) && (a.metadata.is_ecommerce = !0,
        a.copyToHitData(O.g.da),
        a.copyToHitData(O.g.Ba))
    }
      , GI = function(a) {
        if (R(83) && a.metadata.is_conversion && X(O.g.O) && Qt(a, "ga4_ads_linked", !1)) {
            var b = bs(a)
              , c = Hq(b.prefix)
              , d = Ur(c);
            a.j[O.g.yf] = d.Nh;
    ...
    $J.removeItem = function(a) {
        L(this, "access_template_storage");
        var b = JA(this).kb();
        if (!aK[b] || !aK[b].hasOwnProperty("gtm." + a))
            return;
        delete aK[b]["gtm." + a];
    }
    ;
    ...
    function LK() {
        ...
        var a = sk(tk()), b, c = a == null ? void 0 : (b = a.context) == null ? void 0 : b.source;
        c !== 2 && c !== 4 && c !== 3 || V(142);
        tf = Kf
    }
    var MK = !1;
    (function(a) {
        ...
        var g = function(v) {
            ...
            qc("https://" + Ki.xf + "/debug/bootstrap?id=" + Qf.ctid + "&src=" + w + "&cond=" + v + "&gtm=" + Qo()));
            var y = {
                ...
                if (dk().canonical[g]) {
                    ...
                    if (Wj) {
                        ...
                        if (!Re)
                            ...
                            var Ry = ko;
                            Ry !== void 0 && (Re.canonicalContainerId && Kk("rtg", String(Re.canonicalContainerId)),
                            Kk("slo", String(Ry)),
                        ...
                        var Uy = ak;
                        Uy && Kk("pcid", Uy);
                        R(36) && (Kk("bt", String(ej.C ? 2 : Ti ? 1 : 0)),
                    ...
                    KK.bootstrap = Zi;
                    if (R(86)) {}
                    R(113) && (typeof B.name === "string" && vb(B.name, "web-pixel-sandbox-CUSTOM") && Kc() ? nK("dMDg0Yz") : B.Shopify && Kc() && nK("dNTU0Yz"))
                }
            }
        } catch (ho) {
            if (ol(4),
